...
<html>
	...
	<body>
		...
		<div class="menu-bar">
			<div class="language">
				<h5><a href="logging.php" style="color: white;">English</a>	<a href="loggingSinhala.php" style="color: white;">සිංහල</a></h5>
			</div>
			<ul>
			...
			<div class="container">
				<div class="row justify-content-center">
					...
					<form action="<?= $_SERVER['PHP_SELF'] ?>" method="post" class="p-4">
						...
						<div class="form-group">
							<input type="submit" name="login" class="btn btn-success btn-block" value="சமர்ப்பிக்கவும்">
						</div>
