...
<html>
	...
	<body>
		...
		<div class="menu-bar">
			<div class="language">
				<h5><a href="AdminWeather.php" style="color: white;">English</a>	<a href="adminWeatherTamil.php" style="color: white;">தமிழ்</a></h5>
			</div>
			<ul>
				...
				<li class="active"><a href="#"><i class="fa fa-cloud-sun-rain"></i>කාලගුණ</a></li>
			</ul>
		</div>
		</div>
